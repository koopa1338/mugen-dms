    ...
    view! {
        <div class="rounded bg-gray-900 p-3 text-gray-500">
            ...
            <ul class="list-disc ml-6">
                <li>"Outstanding Performance: Mugen-dms is designed for high-speed document handling and management."</li>
                <li>"Emphasis on Safety: Rust's strong type system and memory safety guarantee secure operations."</li>
                <li>"Low Resource Footprint: We prioritize efficiency and minimize resource consumption."</li>
                <li>"Easy Setup: Mugen-dms comes with a straightforward and user-friendly installation process."</li>
                <li>"Open Source: Developed and maintained by a single contributor, available for the community."</li>
            </ul>
            ...
            <p>
                ...
                <a class="transition-all duration-100 ease-in-out text-bold text-white hover:text-amber-600" href="https://github.com/koopa1338/mugen-dms" target="_blank" title="Link to github repository">here</a>
                "."
            </p>
        </div>
    }
